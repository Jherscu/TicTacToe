...
class TicTacToeViewModelTest {
    ...
    fun set_top_horizontal_row_test_row_returns_true() {
        ...
        assertThat("Testing win did not return true for top row",
    ...
    fun set_middle_horizontal_row_test_row_returns_true() {
        ...
        assertThat("Testing win did not return true for middle row",
    ...
    fun set_bottom_horizontal_row_test_row_returns_true() {
        ...
        assertThat("Testing win did not return true for bottom row",
            viewModel.testRow(FakeGameBoardPart.ROW_BOTTOM.part, FakeGameBoardPart.BOX_BOTTOM_RIGHT.part),
            `is`(true)
        )
    }
    ...
    fun set_left_vertical_column_test_column_returns_true() {
        ...
        assertThat("Testing win did not return true for left column",
            viewModel.testRow(FakeGameBoardPart.COLUMN_LEFT.part, FakeGameBoardPart.BOX_TOP_LEFT.part),
            `is`(true)
        )
    }
    ...
    fun set_middle_vertical_column_test_column_returns_true() {
        ...
        assertThat("Testing win did not return true for middle column",
            viewModel.testRow(FakeGameBoardPart.COLUMN_MIDDLE.part, FakeGameBoardPart.BOX_CENTER.part),
            `is`(true)
        )
    }
    ...
    fun set_right_vertical_column_test_column_returns_true() {
        ...
        assertThat("Testing win did not return true for right column",
            viewModel.testRow(FakeGameBoardPart.COLUMN_RIGHT.part, FakeGameBoardPart.BOX_BOTTOM_RIGHT.part),
            `is`(true)
        )
    }
    ...
    fun set_top_left_to_bottom_right_diagonal_test_diagonal_returns_true() {
        ...
        assertThat("Testing win did not return true for top left to bottom right diagonal",
            viewModel.testRow(FakeGameBoardPart.DIAGONAL_TOP_LEFT_TO_BOTTOM_RIGHT.part, FakeGameBoardPart.BOX_CENTER.part),
            `is`(true)
        )
    }
    ...
    fun set_top_right_to_bottom_left_diagonal_test_diagonal_returns_true() {
        ...
        assertThat("Testing win did not return true for top right to bottom left diagonal",
            viewModel.testRow(FakeGameBoardPart.DIAGONAL_TOP_RIGHT_TO_BOTTOM_LEFT.part, FakeGameBoardPart.BOX_CENTER.part),
            `is`(true)
        )
    }
     ...
     */
    @Test
    fun set_top_horizontal_row_test_live_data_values_change() {

        FakeGameBoardModel.testWin(0, FakeGameBoardModel.Horizontal())

        viewModel.testRow(FakeGameBoardPart.ROW_TOP.part, FakeGameBoardPart.BOX_TOP_LEFT.part)

        assertThat("State of viewModel does not reflect isWin as true",
            viewModel.isWin.getOrAwaitValue(),
            `is`(true)
        )

        assertThat("State of viewModel does not reflect winning player",
    ...
    fun set_icon_as_x_confirm_returns_x_icon() {
        assertThat("""getIcon did not return the x icon for value: "X"""",
        viewModel.getIcon("X"),
