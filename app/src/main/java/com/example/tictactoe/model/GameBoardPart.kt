...
import com.example.tictactoe.model.GameBoardModelImpl.gameBoard

enum class GameBoardPart(val part: Set<String>) {
    ...
    DIAGONAL_TOP_LEFT_TO_BOTTOM_RIGHT(setOf(
        gameBoard.value[0][0],
        gameBoard.value[1][1],
        gameBoard.value[2][2]
    )),
    DIAGONAL_TOP_RIGHT_TO_BOTTOM_LEFT(setOf(
        gameBoard.value[0][2],
        gameBoard.value[1][1],
        gameBoard.value[2][0]
    )),
